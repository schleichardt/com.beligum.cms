...
//    }
	...
	try {
	    ...
	    if (page == null) {
		page = Ebean.find(models.Page.class, id);
		if (page != null) {
		    PageCacheRepository.storePage(page);
		}
	    }
    ...
    public static com.beligum.cms.pagers.PagePager findPage(int page, int pageSize, String search)
    {
	try {
	    search = "%" + search + "%";
	    return new com.beligum.cms.pagers.PagePager(Ebean.find(Block.class).findPagingList(pageSize), page, null);
