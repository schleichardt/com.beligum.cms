package com.beligum.cms.managers;
...
import com.beligum.cms.repository.PageCacheRepository;
import com.beligum.cms.templating.Content;
...
public class PageManager
{
	...
	try {
	    ...
	    String templatePackage = (String) play.Play.application().configuration().getString("beligum.cms.template.package");
	    String template = (String) play.Play.application().configuration().getString("beligum.cms.template.default");
	    ...
	    Logger.debug("Error while rendering page:" + e.getMessage());
	    return null;
	}
    }
